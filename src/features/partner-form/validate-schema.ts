...
export const partnerFormSchema = z
  .object({
    ...
    partnerGender: z
      ...
      .refine(
        (val) => partnerGenderValues.includes(val),
        {
    ...
    partnerAgeRange: z
      ...
      .refine(
        (val) => partnerAgeRangeValues.includes(val),
        {
    ...
    keyQuestion: z
      .string()
      .min(5, 'Please provide a more detailed question (at least 5 characters)'),
    ultimateGoal: z
      .string()
      .min(1, 'Ultimate goal is required')
      .refine(
        (val) => ultimateGoalValues.includes(val),
        {
