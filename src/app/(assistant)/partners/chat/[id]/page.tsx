...
import { ArrowLeft, Home, LoaderCircle, Mic, Send } from 'lucide-react';
...
const initialMessages: Message[] = [
  {
    id: '1',
    content:
      'I am Aura. I will help you create a strategy to win Leo, your crush. It will definitely work well.',
    role: 'assistant',
    timestamp: new Date(),
  },
  {
    id: '2',
    content:
      'Based on your compatibility, the best approach is to build a strong friendship first, showing genuine interest in his hobbies.',
    role: 'assistant',
    timestamp: new Date(),
  },
  {
    id: '3',
    content: 'That sounds good, tell me more.',
    role: 'user',
    timestamp: new Date(),
  },
];
